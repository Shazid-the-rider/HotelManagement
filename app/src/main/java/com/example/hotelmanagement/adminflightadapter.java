...
public class adminflightadapter extends RecyclerView.Adapter<adminflightadapter.myviewholder> {
    private Context context;
    private ArrayList<String> usersWithProducts;

    public adminflightadapter(Context context, ArrayList<String> usersWithProducts) {
    ...
    @NonNull
    @Override
    public adminflightadapter.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(context);
        View view = layoutInflater.inflate(R.layout.orderxx, parent, false);
        return new adminflightadapter.myviewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull adminflightadapter.myviewholder holder, int position) {
    ...
    static class myviewholder extends RecyclerView.ViewHolder {
        TextView usernameTextView, productTextView, pricedetails, producttype, dell;
        ...
        public myviewholder(@NonNull View itemView) {
            ...
            dell = itemView.findViewById(R.id.textview5);
        }
    }
}
