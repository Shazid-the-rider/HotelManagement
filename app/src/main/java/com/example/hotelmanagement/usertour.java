...
public class usertour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (dbdata.isEmpty() || dbdata1.isEmpty()) {
            ...
            touradapteR xadapter = new touradapteR(this, dbdata1, dbdata);
        ...
        im.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(usertour.this, account.class));
            }
        });
