...
public class cusAdapter extends RecyclerView.Adapter<cusAdapter.myviewholder> {
    ...
    public cusAdapter(Context context, ArrayList<String> product_name, ArrayList<Float> price, ArrayList<String> Order_Type) {
    ...
    @NonNull
    @Override
    public cusAdapter.myviewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(context);
        View view = layoutInflater.inflate(R.layout.cartsample2, viewGroup, false);

        return new cusAdapter.myviewholder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull cusAdapter.myviewholder holder, int position) {
